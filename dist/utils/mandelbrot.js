 ...
 */
export function uuidToJuliaParams(uuid) {
 ...
 */
function juliaIter(z0, c, maxIter) {
    let zRe = z0.re;
    let zIm = z0.im;
 ...
 */
function iterToColor(iter, maxIter, hue, satBase) {
    if (iter >= maxIter) {
 ...
 */
export function renderMandelbrot(uuid, size = 64, maxIter = 50) {
 ...
 */
export function getMandelbrotBackground(uuid, size = 64) {
